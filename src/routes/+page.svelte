            ...
            {:then [podiums, leagueTeamManagers]}
                {#if podiums[0]}
                    ...
                    <div id="champ"
                         ...
                         onkeydown={(e) => {if(e.key === 'Enter' || e.key === ' ') {e.preventDefault(); if(managers.length) gotoManager({year: podiums[0].year, leagueTeamManagers, rosterID: parseInt(podiums[0].champion)})}}} >
                    ...
                    <span class="label"
                          role="button"
                          tabindex="0"
                          onclick={() => gotoManager({year: podiums[0].year, leagueTeamManagers, rosterID: parseInt(podiums[0].champion)})}
                          onkeydown={(e) => {if(e.key === 'Enter' || e.key === ' ') {e.preventDefault(); gotoManager({year: podiums[0].year, leagueTeamManagers, rosterID: parseInt(podiums[0].champion)})}}} >{getTeamFromTeamManagers(leagueTeamManagers, podiums[0].champion, podiums[0].year).name}</span>
                {:else}
